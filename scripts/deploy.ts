...
async function main(): Promise<void> {
    ...
    const rentableBK721: Contract = await upgrades.deployProxy(
        RentableBK721,
        ["RentableNFC", "RNFC", "https://example/token/", 10000, "0xDc9ec7717E7e6F13fcf02cE1b40b7AFf5fb8Eb1d", "0x7aa44259f7c767503CBEad1D506E9d8782078f27", "0xB255A005b65e986729e70De4d0cAa692914A8350"],
        { kind: "uups", initializer: "init" },
    );
