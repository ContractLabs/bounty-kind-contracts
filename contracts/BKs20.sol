...
} from "oz-custom/contracts/oz-upgradeable/token/ERC20/extensions/ERC20PermitUpgradeable.sol";
...
} from "oz-custom/contracts/oz-upgradeable/token/ERC20/extensions/ERC20PausableUpgradeable.sol";

import {
    TaxableUpgradeable,
    FixedPointMathLib
} from "oz-custom/contracts/internal-upgradeable/TaxableUpgradeable.sol";
import {
...
import {
    IWNTUpgradeable
} from "oz-custom/contracts/presets-upgradeable/token/interfaces/IWNTUpgradeable.sol";

import {IUniswapV2Pair, IBKs20} from "./interfaces/IBKs20.sol";
import {
    ...
    AccessControlEnumerableUpgradeable
{
    ...
    function initialize(
        ...
        IWNTUpgradeable wnt_,
        AggregatorV3Interface priceFeed_
    ) external initializer {
        __Taxable_init(beneficiary_);
